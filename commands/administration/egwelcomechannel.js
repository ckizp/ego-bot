...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const welcomechannel = interaction.guild.channels.cache.get(data.channel);
        ...
        switch (interaction.options.getSubcommand()) {
            case 'check':
                ...
                if (!bot.permissionsIn(welcomechannel).has(PermissionFlagsBits.Administrator))
                    embed.addFields({name: '\u200B', value: ':warning: I don\'t have the permission the join this channel'})
